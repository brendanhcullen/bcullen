...
There are many other great reasons, too. Here are a few that come to mind.

## Teaching resources galore `r fontawesome::fa("gem")`

The [RStudio Education Blog](https://education.rstudio.com/blog/) is a `r emo::ji("gem")` TREASURE TROVE! `r emo::ji("gem")`

## Surge in online teaching `r fontawesome::fa("cloud")`

## Tried and tested `r fontawesome::fa("comments")`

## A community of practice `r fontawesome::fa("users")`
