...
To make the bootcamp materials more accessible and shareable, I decided to package them into a website, which I created using the [blogdown](https://github.com/rstudio/blogdown) package (see more on this [below](#ssn)).
...
`r emo::ji("package")` `r emo::ji("link")` https://pkg.garrickadenbuie.com/xaringanExtra/

`xaringanExtra`, by [Garrick Aden‑Buie](https://www.garrickadenbuie.com/) is one of my all-time favorite packages. Here are the features I use most often and *highly* recommend.
...
`r emo::ji("package")` `r emo::ji("link")` https://r-for-educators.github.io/flair/index.html
...
`r emo::ji("package")` `r emo::ji("link")` https://evamaerey.github.io/flipbooks/about
...
`r emo::ji("package")` `r emo::ji("link")` https://pkg.garrickadenbuie.com/countdown/
...
Taking this one step further, it's a good idea to deliberately incorporate making mistakes into your own teaching and use error messages as a teachable moment. And even use unintentional mistakes as teachable moments -- demonstrates for your students how you fix the mistake, and invite them to give their thoughts and feedback. This not only makes your presentation less rehearsed, but it provides a really valuable context for learning. 
