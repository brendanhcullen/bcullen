...
If you'd like to see an example of a demonstration lesson, below are the materials I created for this portion of the teaching exam. You can find all of the source code for this lesson on <a href= "https://github.com/brendanhcullen/rstudio-instructor-certification">Github</a>. Feel free to share, adapt and re-use for your own teaching.
