...
CV_PDF_LOC <- "https://github.com/brendanhcullen/bcullen/raw/master/static/cv/cullen_cv.pdf"
...
::: aside
```{r}
print_text_block(text_blocks, 'position_experience_aside')
```
:::
...
::: aside
```{r}
print_text_block(text_blocks, 'workshop_experience_aside')
```
:::
